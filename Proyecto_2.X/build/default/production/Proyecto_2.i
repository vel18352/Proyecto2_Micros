...
void __attribute__((picinterrupt(("")))) isr(void)
{
    ...
    if (ADIF)
    {
        ...
        {
            Servo_Pos[0] = ADRESH;
            Servo1_Val = map(Servo_Pos[0],0,255,160,650);
        ...
        {
            Servo_Pos[1] = ADRESH;
            Servo2_Val = map(Servo_Pos[1],0,255,160,650);
            PWM_duty(1,Servo2_Val);
        ...
        {
            Servo_Pos[2] = ADRESH;
            Servo3_Val = map(Servo_Pos[2],0,255,160,650);
            PWM_duty(1,Servo3_Val);
        ...
        {
            Servo_Pos[3] = ADRESH;
            Servo4_Val = map(Servo_Pos[3],0,255,160,650);
            PWM_duty(1,Servo4_Val);
